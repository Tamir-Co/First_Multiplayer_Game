...
public class PlayerCombat : MonoBehaviour
{
    ...
    private void Attack()
    {
        switch (hero_name)
        {
            ...
            case "Mage":
                ...
                StartCoroutine(FireAttack(get_AttackPosition(mage_attack_position)));
                break;
    ...
    private void ExtraAttack()
    {
        switch (hero_name)
        {
            ...
            case "Mage":
                ...
                StartCoroutine(FireAttack(get_AttackPosition(mage_extra_attack_position)));
                break;
    ...
    private IEnumerator FireAttack(Vector2 position)
    {
        yield return new WaitForSecondsRealtime(time_until_attack);
